...
###########################
# macOS Automated Dotfiles
# A script that sets up a relatively secure baseline for macOS with
# a lot of stuff was pulled from Mathias Bynens' dotfiles and
# some of DrDuh's recommendations sprinkled in.
# Original author and credit goes to Adam Eivy
###########################
...
bot "Initailzing System Baseline Configuration..."
...
# Let's get started with securing our comms...
# Enable Firewall
bot "Enabling System Firewall..."
sudo /usr/libexec/ApplicationFirewall/socketfilterfw --setglobalstate on
# Enable logging
bot "Enabling Firewall logging..."
sudo /usr/libexec/ApplicationFirewall/socketfilterfw --setloggingmode on
# Enable Steath mode: No response to ICMP / ping requests
bot "Enabling Stealth Mode to block HAX0RZ from pinging your machine..."
sudo /usr/libexec/ApplicationFirewall/socketfilterfw --setstealthmode on
# Disable macOS from phoning home
bot "Stoping macOS from phoning home..."
init/homecall.sh fixmacos
ok

# Configure /etc/hosts
read -r -p "Overwrite /etc/hosts with the ad-blocking hosts file from Steven Black (Unified Hosts+FakeNews+Gambling+Porn+Social)? [y|N] " response
if [[ $response =~ (yes|y|Y) ]];then
    action "cp /etc/hosts /etc/hosts.backup"
    sudo cp /etc/hosts /etc/hosts.backup
    ok
    action "$(curl -fsSL https://raw.githubusercontent.com/StevenBlack/hosts/master/alternates/fakenews-gambling-porn-social/hosts) > /etc/hosts"
    ok
...
if [[ ! -d "./oh-my-zsh/custom/themes/bullet-train" ]]; then
...
require_cask font-monoid-nerd-font
...
###############################################################################
bot "Configuring a Secure macOS basline..."
bot "Starting with General System UI/UX changes..."
###############################################################################
...
running "enabling system firewall"
sudo defaults write /Library/Preferences/com.apple.alf globalstate -int 1

# Enable firewall stealth mode (no response to ICMP / ping requests)
# Source: https://support.apple.com/kb/PH18642
#sudo defaults write /Library/Preferences/com.apple.alf stealthenabled -int 1
running "enabling stealth mode"
sudo defaults write /Library/Preferences/com.apple.alf stealthenabled -int 1
...
running "Set highlight color to graphite"
defaults write NSGlobalDomain AppleHighlightColor -string "0.847059 0.847059 0.862745";ok
...
running "Bottom right screen corner → Start screen save"
